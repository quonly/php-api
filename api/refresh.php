...
try {
    ...
    http_response_code(400);
    echo json_encode(["message" => "invalid toekn"]);
    exit;
}
...
$refresh_token_gateway = new RefreshTokenGateway(
    $database,
    $_ENV["SECRET_KEY"]
);
...
[$refresh_token, $payload] = require __DIR__ . "/tokens.php";

echo $payload;

$refresh_token_gateway->delete($data["token"]);

$refresh_token_gateway->create(
    $refresh_token,
